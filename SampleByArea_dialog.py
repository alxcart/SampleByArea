...
FORM_CLASS, _ = uic.loadUiType(os.path.join(
    os.path.dirname(__file__), 'SampleByArea_dialog_base.ui'))


class SampleByAreaDialog(QtWidgets.QDialog, FORM_CLASS):
    def __init__(self, parent=None):
        """Constructor."""
        super(SampleByAreaDialog, self).__init__(parent)
